...
class Typus::FilePreviewHelperTest < ActiveSupport::TestCase
  ...
  context "typus_file_preview_for_dragonfly" do
    ...
    should "return image and link for image files" do
      @asset = Factory(:asset)
      assert_equal "typus/helpers/file_preview", typus_file_preview_for_dragonfly(@asset.dragonfly).first
  ...
  context "typus_file_preview_for_paperclip" do
    ...
    should "return image and link for image files" do
      expected = ["typus/helpers/file_preview",
