...
class Typus::ImageHoldersControllerTest < ActionController::TestCase
  ...
  context "create polymorphic association" do
    ...
    should "work" do
      ...
      assert_redirected_to "http://test.host/typus/birds/edit/#{@bird.id}"
  ...
  context "unrelate" do
    ...
    #
    #   /typus/image_holders/unrelate/1?resource=Bird&resource_id=1
    #   /typus/image_holders/unrelate/2?resource=Bird&resource_id=1
    #   ...
    ##
    ...
    setup do
      ...
      @request.env['HTTP_REFERER'] = "/typus/birds/edit/#{@bird.id}"
    end
