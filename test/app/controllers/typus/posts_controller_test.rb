...
class Typus::PostsControllerTest < ActionController::TestCase
...
#{@post.title};#{@post.status}
  ...
  context "Relationships (relate)" do
    ...
    should "relate comment to post (has_many)" do
      ...
      @request.env['HTTP_REFERER'] = "/typus/posts/edit/#{@post.id}#comments"
    ...
    should "relate category to post (has_and_belongs_to_many)" do
      ...
      @request.env['HTTP_REFERER'] = "/typus/posts/edit/#{@post.id}#categories"
