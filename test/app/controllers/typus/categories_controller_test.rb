...
class Typus::CategoriesControllerTest < ActionController::TestCase
  ...
  context "Unrelate (has_and_belongs_to_many)" do
    ...
    #
    #   /typus/categories/unrelate/1?resource=Post&resource_id=1
    #   /typus/categories/unrelate/2?resource=Post&resource_id=1
    ##

    setup do
      @category = Factory(:category)
      @category.posts << Factory(:post)
      @request.env['HTTP_REFERER'] = "/typus/dashboard"
    end
  ...
  ##
  # Basically we verify Typus::ResourcesController#create_with_back_to works
  ...
  #
  #   /typus/categories/new?back_to=%2Fadmin%2Fcases%2Fedit%1F2&resource=Case&resource_id=2
  #
