...
class Typus::DashboardControllerTest < ActionController::TestCase

  context "When authentication is http_basic" do

    setup do
      Typus::DashboardController.send :include, Typus::Authentication::HttpBasic
    end
  ...
  context "When authentication is none" do
    ...
    setup do
      Typus::DashboardController.send :include, Typus::Authentication::None
    end
