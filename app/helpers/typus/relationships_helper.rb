module Typus
  module RelationshipsHelper
    ...
    def typus_form_has_many(field)
      ...
      if set_condition && !count_items_to_relate.zero?
        form = if count_items_to_relate > Typus.autocomplete
                 build_relate_form('typus/templates/relate_form_with_autocomplete')
               else
    ...
    def build_relate_form(template = "typus/templates/relate_form")
    ...
    def build_add_new(options = {})
      default_options = { :controller => "/typus/#{@model_to_relate.to_resource}",
                          :action => "new",
    ...
    def typus_form_has_one(field)
      ...
      render "typus/templates/has_one",
             :association_name => @association_name,
    ...
    def typus_belongs_to_field(attribute, form)
      ...
      template = if related.respond_to?(:roots) || !(related.count > Typus.autocomplete)
                   "typus/templates/belongs_to"
                 else
                   "typus/templates/belongs_to_with_autocomplete"
                 end
