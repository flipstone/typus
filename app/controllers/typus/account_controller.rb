class Typus::AccountController < Typus::BaseController

  layout 'typus/session'
  ...
  def show
    ...
    redirect_to :controller => "/typus/#{Typus.user_class.to_resource}", :action => "edit", :id => typus_user.id
  end
